...
class FooTest : public testing::Test {
 protected:
  ...
  FooTest() {
     // You can do set-up work for each tst here.
  }
  ...
  // and cleaning up each tst, you can define the following methods:
  ...
  void TearDown() override {
     // Code here will be called immediately after each tst (right
     // before the destructor).
  }

  // Class members declared here can be used by all tests in the tst suite
  // for Foo.
};
